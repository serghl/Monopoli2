package boxes; /*
 ...
 import java.util.Scanner;
    ...
    // Method to crete a board with diferent "sons" of boxes.Box class
        public static Box[] readTxt() throws FileNotFoundException {
            File file = new File("./src/aux/boxBoard1.txt");
            ...
            while (sc.hasNext() && i < monopolyBoard.length) {
                ...
                if (idBox == i && type.equals("Start")) {
                    ...
                    i++;
                } else if (idBox == i && type.equals("boxes.JailBox")) {
...
*/
     ...
     // Method to return the boxes.Box type, to work it out with the misc.ActionsOnLand
